# Generated by Django 2.1.1 on 2019-07-29 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StoreApp.Goods', verbose_name='商品 id')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsType',
        ...
        migrations.AddField(
            model_name='store',
            name='type',
            field=models.ManyToManyField(to='StoreApp.StoreType', verbose_name='店铺类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goods_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StoreApp.GoodsType', verbose_name='商品类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='StoreApp.Store', verbose_name='商品店铺'),
        ),
    ]
